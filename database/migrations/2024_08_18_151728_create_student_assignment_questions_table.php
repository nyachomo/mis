...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('student_assignment_questions', function (Blueprint $table) {
            $table->id();
            ...
            $table->unsignedBigInteger('student_assignment_id'); // Foreign key
    ...
    {
        Schema::dropIfExists('student_assignment_questions');
    }
};
