          ...
          <div class="card">
                 <div class="card-header">
                    ...
                    <div class="btn-group1" style="float:right">
                        ...
                        <button class="btn btn-secondary btn-sm" data-toggle="modal" data-target="#uploadUsersModal"><i class="fa fa-file-excel-o"></i>Import Trainees</button>
                        <button class="btn btn-success btn-sm" data-toggle="modal" data-target="#addUserModal"><i class="fa fa-user-plus"></i>Add New Trainee</button>
                                                ...
                                                <div class="card-body">
                                                       ...
                                                       <ol>
                                                        @if(!empty($courses))
                                                            ...
                                                            <li><input type="checkbox"  name="course_id"value="{{$course->id}}"> {{$course->course_name}} -{{$course->course_level}} (<b> Ksh {{$course->course_price}}</b>) </li>
...
<div class="modal  fade " id="addUserModal">
  <div class="modal-dialog ">
    <div class="modal-content">
        <div class="modal-header">
            <h6 class="modal-title">Add New Trainee</h6>
            <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
        </div>
        <form role="form" method="POST" action="{{route('adminAddUsers')}}">
            ...
            <div class="card-body">
                    ...
                    <div class="row">
                       ...
                       <div class="col-sm-12">
                           <input type="checkbox" name="is_trainee" value="Yes" hidden="true" checked> 
                            <div class="form-group">
                                <label>Email Address<sup>*</sup></label>
...
<div class="modal  fade " id="uploadUsersModal">
  <div class="modal-dialog">
    <div class="modal-content">
        <div class="modal-header">
            <h6 class="modal-title">Upload Trainee</h6>
            <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
        </div>
            <!-- /.card-header -->
            <div class="card-body">
                <form action="{{ route('adminImportTraineesFromExcel') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                       <div class="row">
                              <div class="col-sm-12">
                                 <div class="form-group" style="float:right">
                                     <a href="{{route('downloadTraineeImportFile')}}">Download File</a>
                                 </div>
                              </div>
                       </div>
                        <div class="row">
