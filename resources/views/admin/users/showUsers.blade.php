                            ...
                            <tr>
                                ...
                                <!-- Example single danger button -->
                                    <div class="btn-group">
                                        ...
                                        <ul class="dropdown-menu">
                                            <li><center><a class="dropdown-item" href="#"><b>More Action</b></a></center></li>
                                            <li><a class="dropdown-item" data-toggle="modal" data-target="#update_user{{$user->id}}" href="#"> <i class="fa fa-edit las1"></i> Update User Info</a></li>
                                                ...
                                                <div class="card-body">
                                                      <form method="post" action="{{route('adminRevokeUsersRoles')}}">
                                                       ...
                                                       <div class="row">
                                                            ...
                                                            @if($user->is_exam_officer=='Yes')
                                                            <div class="col-sm-4">
                                                                 <input type="checkbox" name="is_exam_officer" value="" > Exam Officer
                                                            </div>
                                                            @endif

                                                            @if($user->is_data_clerk=='Yes')
                                                            <div class="col-sm-4">
                                                                 <input type="checkbox" name="is_data_clerk" value="" > Data Clerk 
                                                            </div>
                                                            @endif
                                                        ...
                                                        <div class="row">
                                                           ...
                                                           <input type="text" name="id" value="{{$user->id}}" hidden="true"> 
                                                            ...
                                                            @if($user->is_exam_officer=='')
                                                            <div class="col-sm-4">
                                                                 <input type="checkbox" name="is_exam_officer" value="Yes" > Exam Officer
                                                            </div>
                                                            @endif

                                                            @if($user->is_data_clerk=='')
                                                            <div class="col-sm-4">
                                                                 <input type="checkbox" name="is_data_clerk" value="Yes" > Data Clerk 
                                                            </div>
                                                            @endif
