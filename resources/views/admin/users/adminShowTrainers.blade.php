        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active"> Manage Trainers</li>
          ...
          <div class="card">
                 <div class="card-header">
                    ...
                    <div class="btn-group1" style="float:right">
                        ...
                        <button class="btn btn-success btn-sm" data-toggle="modal" data-target="#addUserModal"><i class="fa fa-user-plus"></i>Add New Trainer</button>
