...
<section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            @if(!empty($studentcat))
             <h4>Questions for: {{$studentcat->exam_name}}</h4>
            @else
                ...
                <div class="card-header">
                    <div class="row">
                        <div class="col-sm-6" style="border-right:1px solid red">
                            @if(!empty($studentcat))
                            <ol>
                                <li><i class="fa fa-bookmark-o" aria-hidden="true"></i>  <b>Exam Name </b>: {{$studentcat->exam_name}}</li>
                        ...
                        <div class="col-sm-6">
                            <div class="btn-group1">
                                ...
                                <button class="btn btn-danger btn-sm" data-toggle="modal" data-target="#archivedQuestionModal"> {{$arcivedstudentcatquestions->count()}} ARCHIVED QUESTIONS </button>
                                ...
                                <div class="btn-group">
                                    ...
                                    <div class="dropdown-menu" style="padding-left:10px">
                                        <form method="post" action="{{route('adminExportCatQuestionsAsPdf')}}">
                                            @csrf
                                            <input type="text" name="exam_id" value="{{$studentcat->id}}" hidden="true">
                                ...
                                <br><br>
                                    <ol>
                                        <li>Active Questions: {{$activestudentcatquestions->count()}}</li>
                                        <li>Total Marks:  {{$studentcat->exam_total_score}}</li>
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table table-sm table-bordered table-stripped" id="example1">
                            ...
                            <tbody>
                               @if(!empty($activestudentcatquestions))
                                  @foreach($activestudentcatquestions as $key=>$question)
                                      <tr>
                                           <td>{{$key+1}}</td>
                                    ...
                                    <div class="modal-dialog modal-lg">
                                        <div class="modal-content">
                                            ...
                                            <form role="form" method="POST" action="{{route('adminUpdateCatQuestions')}}">
                                                @csrf
                                                <!-- /.card-header -->
                                                <div class="card-body">
                                     ...
                                     <div class="modal  fade " id="delete_question{{$question->id}}">
                                        <div class="modal-dialog modal-sm">
                                            <div class="modal-content">
                                                ...
                                                <form role="form" method="POST" action="{{route('adminArchivedCatQuestions')}}">
                                                    @csrf
                                                    <!-- /.card-header -->
                                                    <div class="card-body">
...
<div class="modal  fade " id="addNewQuestionModal">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
        ...
        <form role="form" method="POST" action="{{route('adminAddCatQuestions')}}">
            @csrf
            <!-- /.card-header -->
            <div class="card-body">
                <div class="row" hidden="true">
                    <div class="col-sm-4">
                         <input type="text" name="student_cat_id" value="{{$studentcat->id}}">
                    </div>
                    <div class="col-sm-4">
                         <input type="text" name="department_id" value="{{$studentcat->department_id}}">
                    </div>
                    <div class="col-sm-4">
                         <input type="text" name="course_id" value="{{$studentcat->course_id}}">
                    </div>

                    <div class="col-sm-4">
                         <input type="text" name="clas_id" value="{{$studentcat->clas_id}}">
                    </div>
            ...
            <div class="card-body">
                    <div class="table-responsive">
                        <table class="table table-sm table-bordered table-stripped" id="example1">
                            ...
                            <tbody>
                               @if(!empty($arcivedstudentcatquestions))
                                  @foreach($arcivedstudentcatquestions as $key=>$question)
                                      <tr>
                                           <td>{{$key+1}}</td>
                                           <td> <?php echo$question->question_name?> </td>
                                           <td> <?php echo$question->question_answer?> </td>
                                           ...
                                           <td>
                                               <form method="post" action="{{route('adminRecoverCatQuestions')}}">
                                                  @csrf
                                                  <input type="text" name="id" value="{{$question->id}}" class="form-control" hidden="true">
