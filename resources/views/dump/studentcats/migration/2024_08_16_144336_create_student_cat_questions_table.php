...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('student_cat_questions', function (Blueprint $table) {
            $table->id();
            ...
            $table->unsignedBigInteger('student_cat_id'); // Foreign key
            $table->foreign('department_id')->references('id')->on('departments')->onDelete('cascade');
            $table->foreign('course_id')->references('id')->on('courses')->onDelete('cascade');
            $table->foreign('clas_id')->references('id')->on('clas')->onDelete('cascade');
            $table->foreign('student_cat_id')->references('id')->on('student_cats')->onDelete('cascade');
            $table->timestamps();
        });
    }
    ...
    {
        Schema::dropIfExists('student_cat_questions');
    }
};
