...
<section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Continuous Assesment Test (Cats)</h1>
          </div>
          <div class="col-sm-6">
                            ...
                            <div class="btn-group">
                                ...
                                <div class="btn-group">
                                    ...
                                    <div class="dropdown-menu">
                                        ...
                                        <a class="dropdown-item" href="{{route('adminExportStudentCatsAsPdf')}}"> <i class="las la-edit las1"></i> Export Pdf</a>
                                            ...
                                            <td>
                                                ...
                                                <div class="dropdown">
                                                    ...
                                                    <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                                                        ...
                                                        @endif
                                                        <li>
                                                            <a href="{{url('/adminShowCatQuestions/'.$exam->id)}}" class="dropdown-item" >
                                        ...
                                        <div class="modal  fade " id="update_exam{{$exam->id}}">
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    ...
                                                    <form role="form" method="POST" action="{{route('adminUpdateStudentCats')}}" >
                                                        @csrf
                                                        <!-- /.card-header -->
                                                        <div class="card-body">
                                        ...
                                        <div class="modal  fade " id="publish_exam{{$exam->id}}">
                                            <div class="modal-dialog modal-sm">
                                                <div class="modal-content">
                                                    ...
                                                    <form role="form" method="POST" action="{{route('adminPublishedStudentCats')}}" >
                                                        @csrf
                                                        <!-- /.card-header -->
                                                        <div class="card-body">
                                                                <div class="row">
                                        ...
                                        <div class="modal  fade " id="archive_exam{{$exam->id}}">
                                            <div class="modal-dialog modal-sm">
                                                <div class="modal-content">
                                                    ...
                                                    <form role="form" method="POST" action="{{route('adminArchiveStudentCats')}}" >
                                                        @csrf
                                                        <!-- /.card-header -->
                                                        <div class="card-body">
                                                                <div class="row">
...
<div class="modal  fade " id="modal-xl">
  <div class="modal-dialog">
    <div class="modal-content">
        ...
        <form role="form" method="POST" action="{{route('adminAddStudentCats')}}">
            @csrf
            <!-- /.card-header -->
            <div class="card-body">
                    <div class="row">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="exam_type" class="form-control" value="CAT" hidden="true">
                                ...
                                @if($archivedexams->count()>0)
                                    ...
                                    <tr>
                                            ...
                                            <td>
                                                ...
                                                <form action="{{route('adminRecoverStudentCats')}}" method="post">
                                                    @csrf
                                                    <input type="text" name="id" class="form-control" value="{{$exam->id}}">
