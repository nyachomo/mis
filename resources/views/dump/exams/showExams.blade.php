                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-5">
                            <div class="btn-group1">
                                ...
                                <button class="btn btn-danger btn-sm" data-toggle="modal" data-target="#modal-xl"><i class="las la-plus"></i>ARCHIVED</button>
                                <button class="btn btn-secondary btn-sm" data-toggle="modal" data-target="#modal-xl"><i class="las la-plus"></i>DOWNLOAD</button>
                            </div>
                        </div>
                    </div>
                                            ...
                                            <td>
                                                ...
                                                <div class="dropdown">
                                                    ...
                                                    <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                                                        ...
                                                        <div class="dropdown-divider"></div>
                                                        <li>
                                                            <a href="{{url('/admin/ShowQuestions/'.$exam->id)}}" class="dropdown-item" >
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-sm-12">
                                                                        ...
                                                                        <select class="form-control" name="course_id" required>
                                                                            <option value="{{$exam->course->id}}">{{$exam->course->name}}</option>
                                                                            @if(!empty($courses))
                                        ...
                                        <div class="modal  fade " id="publish_exam{{$exam->id}}">
                                            <div class="modal-dialog modal-sm">
                                                <div class="modal-content">
                                                    ...
                                                    <form role="form" method="POST" action="{{route('adminPublishExams')}}" >
                                                        @csrf
                                                        <!-- /.card-header -->
                                                        <div class="card-body">
                                                                <div class="row">
                                        ...
                                        <div class="modal  fade " id="archive_exam{{$exam->id}}">
                                            <div class="modal-dialog modal-sm">
                                                <div class="modal-content">
                                                    ...
                                                    <form role="form" method="POST" action="{{route('adminArchiveExams')}}" >
                                                        @csrf
                                                        <!-- /.card-header -->
                                                        <div class="card-body">
                                                                <div class="row">
...
<div class="modal  fade " id="modal-xl">
  <div class="modal-dialog">
    <div class="modal-content">
        ...
        <form role="form" method="POST" action="{{route('adminAddExams')}}">
            @csrf
            <!-- /.card-header -->
            <div class="card-body">
                    <div class="row">
                                ...
                                @if($archivedexams->count()>0)
                                    ...
                                    <tr>
                                            ...
                                            <td>
                                                ...
                                                <form action="{{route('adminRecoverExams')}}" method="post">
