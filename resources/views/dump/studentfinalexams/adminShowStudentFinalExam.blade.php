                ...
                <div class="card-header">
                    <div class="row">
                        <div class="col-sm-3" style="border-right:1px solid red">
                            <ol>
                                <li>Total Exams: &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;{{$finalexams->count()}}</li>
                                <li>Published Exams: &nbsp; &nbsp; &nbsp; &nbsp;  &nbsp;{{$publishedexams->count()}}</li>
                                <li>Not Published Exams: &nbsp;{{$notpublishedexams->count()}}</li>
                                <li>Archived Exams: &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;{{$archivedexams->count()}} <a href="#"><span class="right badge badge-danger" data-toggle="modal" data-target="#archiveExamsModal">View</span></a></li>
                            </ol>
                        </div>
                        <div class="col-sm-3">
                            ...
                            <div class="btn-group">
                                ...
                                <div class="btn-group">
                                    ...
                                    <div class="dropdown-menu">
                                        ...
                                        <a class="dropdown-item" href="{{route('adminExportStudentFinalExamAsPdf')}}"> <i class="las la-edit las1"></i> Export Pdf</a>
                        ...
                        <table class="table table-sm table-bordered table-stripped" id="example1">
                            ...
                            <tbody>
                                @if($finalexams->count()>0)
                                    @foreach($finalexams as $key=>$exam)
                                    <tr>
                                            ...
                                            <td>
                                                ...
                                                <div class="dropdown">
                                                    ...
                                                    <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                                                        ...
                                                        @endif
                                                        <li>
                                                            <a href="{{url('/adminShowStudentFinalExamQuestions/'.$exam->id)}}" class="dropdown-item" >
                                        ...
                                        <div class="modal  fade " id="update_exam{{$exam->id}}">
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    ...
                                                    <form role="form" method="POST" action="{{route('adminUpdateStudentFinalExam')}}" >
                                                        @csrf
                                                        <!-- /.card-header -->
                                                        <div class="card-body">
                                        ...
                                        <div class="modal  fade " id="add_question{{$exam->id}}">
                                            <div class="modal-dialog modal-lg">
                                                <div class="modal-content">
                                                    ...
                                                    <form role="form" method="POST" action="{{route('adminAddQuestions')}}">
                                                        @csrf
                                                        <!-- /.card-header -->
                                                        <div class="card-body">
                                        ...
                                        <div class="modal  fade " id="publish_exam{{$exam->id}}">
                                            <div class="modal-dialog modal-sm">
                                                <div class="modal-content">
                                                    ...
                                                    <form role="form" method="POST" action="{{route('adminPublishStudentFinalExam')}}" >
                                                        @csrf
                                                        <!-- /.card-header -->
                                                        <div class="card-body">
                                                                <div class="row">
                                        ...
                                        <div class="modal  fade " id="archive_exam{{$exam->id}}">
                                            <div class="modal-dialog modal-sm">
                                                <div class="modal-content">
                                                    ...
                                                    <form role="form" method="POST" action="{{route('adminArchiveStudentFinalExam')}}" >
                                                        @csrf
                                                        <!-- /.card-header -->
                                                        <div class="card-body">
                                                                <div class="row">
...
<div class="modal  fade " id="modal-xl">
  <div class="modal-dialog">
    <div class="modal-content">
        ...
        <form role="form" method="POST" action="{{route('adminAddStudentFinalExam')}}">
            @csrf
            <!-- /.card-header -->
            <div class="card-body">
                    <div class="row">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="exam_type" class="form-control" value="FINAL EXAM" hidden="true">
                                ...
                                @if($archivedexams->count()>0)
                                    ...
                                    <tr>
                                            ...
                                            <td>
                                                ...
                                                <form action="{{route('adminRecoverStudentFinalExam')}}" method="post">
                                                    @csrf
